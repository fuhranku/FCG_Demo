...
public:
	...
	*/
	...
	/**
	* Sets an directional light uniforms 
	* @param{*shader} light shader
	* @param{dir_light} dir light data container
	*/
	static void setDirectionalLight(Shader *shader, Light dir_light);
	static void setMVPUniforms(Shader *shader, glm::mat4 model, glm::mat4 view, glm::mat4 projection);
	static void setModelMaterials(Shader *shader, Material material);
	static void setPointLight(Shader *shader, Light pointlight, int index);
	static void setSpotLight(Shader *shader, Light *spotlight, Camera camera);
	static void configModelShader(Shader *shader, Model *model, std::vector<Light *> light, glm::mat4 modelM,
